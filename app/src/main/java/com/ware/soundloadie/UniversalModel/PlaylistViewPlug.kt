...
data class PlaylistViewModel (var title:String,var author:String,var link:String,var image:String,var id:String)
class  PlaylistViewAdapter(var context: Context, var arraylists: ArrayList<PlaylistViewModel>, var audioList:ArrayList<Audio>, var playlist: Box<Playlist>, var views: View, var actives: PlaylistView) :
    ...
    class Item(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bindData(_data: PlaylistViewModel) {
