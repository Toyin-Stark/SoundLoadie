...
import kotlinx.android.synthetic.main.video_row_b.view.*

data class VideoModel (var title:String,  var link:String, var id:String,var published:Long)
class VideoPlugAdapter(var context: Context, var arraylists: ArrayList<VideoModel>) :
        RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): RecyclerView.ViewHolder? {
        var v = LayoutInflater.from(context).inflate(R.layout.video_row_b, parent, false)
        return Item(v)
    }
