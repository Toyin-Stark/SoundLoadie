...
data class HotModel(val title:String, val desc:String,val imagelink:String)

class HotAdapter(var c: Context, var lists: ArrayList<HotModel>, var popular: Charts) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    class Item(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bindData(_list: HotModel,popular: Charts) {
