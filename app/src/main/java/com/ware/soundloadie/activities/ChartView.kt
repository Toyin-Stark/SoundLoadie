...
class ChartView : AppCompatActivity() {
    ...
    var arraylistx =  ArrayList<MusicModel2>()
    var mykeys = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adView = AdView(this@ChartView, getString(R.string.banner), AdSize.BANNER_HEIGHT_50)
        ...
        if (types.contains("top")){
            ...
            titlez.text = getString(R.string.type_text)

        }else{

            titlez.text = getString(R.string.type_text2)
    ...
    fun startAudio(plays:String,subject:String,type:String)
    {
            ...
            override fun subscribe(subscriber: ObservableEmitter<String>) {
                try {
                    ...
                    val request = Request.Builder()
                            .url("https://api-v2.soundcloud.com/charts?kind=$type&genre=soundcloud%3Agenres%3A$plays&client_id=$mykeys&limit=50&offset=0")
                            .build()
        ...
        observable!!.subscribeOn(Schedulers.io())
                ...
                .subscribe(object: Observer<String> {
                    ...
                    override fun onComplete() {
                        ...
                        val wave = MusicPlugAdapter2(applicationContext,arraylistx, audioList,playlist!!,constantines,this@ChartView)
                    ...
                    override fun onNext(response: String) {
                        ...
                        try {
                            ...
                            for (i in 0..jsonarr.length() - 1) {
                                ...
                                val author = jsonobj.getJSONObject("track").getJSONObject("user").getString("username")
                                val art = jsonobj.getJSONObject("track").getString("artwork_url")
                                val genre = jsonobj.getJSONObject("track").getString("genre")
                                val link = jsonobj.getJSONObject("track").getString("permalink_url")
                                val ids = jsonobj.getJSONObject("track").getString("id")
                                ...
                                arraylistx.add(MusicModel2(titles, author, link, art, ids))
    ...
    fun shareMatrix(audioIndex: Int)
    {
        ...
        val storage = StorageUtil(this@ChartView)
